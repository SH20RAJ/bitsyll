...
export default function RecentVisited() {
  ...
  return (
    <div>
      ...
      <h2 className="text-2xl font-bold p-1 ">Recent Visited <span className=" w-full self-end ">{""}</span></h2>
      ...
      ">
        { hashistory ? (
          ...
          [1, 2, 3].map((item) => {
            return (
              <Card key={item} className="w-[30%] hover:outline-2 hover:shadow-lg cursor-pointer">
