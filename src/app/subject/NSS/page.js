      ...
      <div className="flex flex-col gap-4 justify-center items-center h-28 mt-20">
        <div>
          <Avatar className="h-20 w-20">
            <AvatarImage
              src="https://freesvg.org/img/nicubunu-Hammer.png"
              alt="@shadcn"
            />
            <AvatarFallback>NSS</AvatarFallback>
          </Avatar>
        </div>
        <h2 className="text-2xl font-bold  mb-4 text-center">
          {" "}
          <span className=" text-lg underline">(NSS)</span> <br />{" "}
          NSS
        </h2>{" "}
      </div>
...
export function PDFs() {
  let pdfs = [
    {
      title: "NSS 1",
      link: "https://drive.google.com/file/d/1BhgTCdCky7eQbr0rq1S4nKhUtD6PH3KO/view?usp=drive_link",
    },
    {
      title: "NSS 2",
      link: "https://drive.google.com/file/d/10RzQx1rcM0tsz64TQHeUVTrF3bmaOknO/view?usp=sharing"
    }
  ];
  return (
    <div className="pdfs">
