        ...
        <div>
          <Avatar className="h-20 w-20">
            <AvatarImage
              ...
              alt="@shadcn"
            />
            <AvatarFallback>Workshop</AvatarFallback>
          </Avatar>
        </div>
        <h2 className="text-2xl font-bold  mb-4 text-center">
          {" "}
          <span className=" text-lg underline">(PE24102)</span> <br />{" "}
          Workshop
        </h2>{" "}
      </div>
...
export function PDFs() {
  let pdfs = [
    {
      title: "Lab Manual",
      link: "https://drive.google.com/file/d/1N3-2Zor8hkZl-If7yUOHp80LA_0KcRAp/view?usp=drive_link",
    }
  ];
  return (
    <div className="pdfs">
